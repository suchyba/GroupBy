...
namespace GroupBy.Data.Migrations
{
    ...
    [Migration("20250312181719_Refactor-finances-add-account-book-template")]
    partial class Refactorfinancesaddaccountbooktemplate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GroupBy.Domain.Entities.FinancialCategory", b =>
                {
                    ...
                    b.Property<Guid?>("AccountingBookTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AccountingBookTemplateId");
            ...
            modelBuilder.Entity("GroupBy.Domain.Entities.FinancialCategory", b =>
                {
                    b.HasOne("GroupBy.Domain.Entities.AccountingBookTemplate", null)
                        .WithMany("Categories")
                        .HasForeignKey("AccountingBookTemplateId");
                });
